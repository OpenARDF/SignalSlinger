...
extern volatile time_t g_evteng_loaded_start_epoch;
extern volatile time_t g_event_finish_epoch;
extern volatile time_t g_evteng_loaded_finish_epoch;
...
extern volatile float g_internal_bat_voltage;
extern volatile bool g_internal_bat_detected;
extern volatile float g_external_voltage;
extern volatile float g_processor_temperature;
extern volatile float g_processor_min_temperature;
extern volatile float g_processor_max_temperature;
extern volatile bool g_restart_conversions;
extern volatile bool g_seconds_transition;
extern volatile bool g_muteAfterID;
extern volatile uint32_t g_event_checksum;
...
extern uint8_t g_frequency_to_test;
...
extern volatile uint16_t isMasterCountdownSeconds;
